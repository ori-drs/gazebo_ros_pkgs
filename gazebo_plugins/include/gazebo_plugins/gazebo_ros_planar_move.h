...
namespace gazebo {
  ...
  class GazeboRosPlanarMove : public ModelPlugin {
    ...
    private:
      ...
      ignition::math::Vector3d linear_cmd_;
      ignition::math::Vector3d angular_cmd_;
      ignition::math::Vector3d last_linear_cmd_;
      ignition::math::Vector3d last_angular_cmd_;
                                ...
                                std::string &_entityName)
     {
       ...
       ignition::math::Vector3d start = _fromEntity->WorldPose().Pos();
       ...
       while ( entityBelow && ( entityBelow->GetParentModel() == _fromEntity->GetParentModel() ) ) {
         ...
         entityBelow = parent_->GetWorld()->EntityByName(_entityName);
         start[2] -= (_distBelow + 0.00001);
       }
       _distBelow += 0.00001;
